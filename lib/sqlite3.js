...
// Database#runSync(sql, [bind1, bind2, ...])
Database.prototype.runSync = normalizeMethod(function(statement, params) {
    statement.runSync.apply(statement, params).finalizeSync();
    return this;
});
...
// Database#getSync(sql, [bind1, bind2, ...])
Database.prototype.getSync = normalizeMethod(function(statement, params) {
    var result = statement.getSync.apply(statement, params);
...
// Database#allSync(sql, [bind1, bind2, ...])
Database.prototype.allSync = normalizeMethod(function(statement, params) {
    var result = statement.allSync.apply(statement, params);
    statement.finalizeSync();
