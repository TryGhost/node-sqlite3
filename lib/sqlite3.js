...
Database.prototype.runAsPromise = function() {
    return dataPromisse.call(this, 'run', arguments)
}
...
Database.prototype.getAsPromise = function() {
    return dataPromisse.call(this, 'get', arguments, true)
}
...
Database.prototype.allAsPromise = function() {
    return dataPromisse.call(this, 'all', arguments, true)
}
...
function dataPromisse (method, params, hasData) {
    return new Promise((resolve, reject) => {
        this[method](...params, function (error, data) {
            if (error) reject(error)
            else
                resolve(hasData ? data : this)
        })
    })
}
