...
Database.Promisses = class extends Database {
    constructor() {
        super(...arguments)
    }
    ...
    run() {
        return new Promise((resolve, reject) => {
            super.run(...arguments, function (error) {
                if(error)
                    reject(error)
                else
                    resolve.call(this)
    ...
    get() {
        return new Promise((resolve, reject) => {
            super.get(...arguments, function (error, row) {
                if(error)
                    reject(error)
                else
                    resolve.call(this, row)
            })
        })
    }
    ...
    all() {
        return new Promise((resolve, reject) => {
            super.all(...arguments, function (error, rows) {
                if(error)
                    reject(error)
                else
                    resolve.call(this, rows)
            })
        })
    }
}
